...
class ContentFactura extends StatefulWidget {
  @override
  _ContentFacturaState createState() => _ContentFacturaState();
}

class _ContentFacturaState extends State<ContentFactura> {
