...
import 'package:tecnomotriz_control_tareas/bloc/login.dart';
import 'package:tecnomotriz_control_tareas/models/welcome_message_model.dart';
import 'package:tecnomotriz_control_tareas/provider/employee_provider.dart';
import 'package:tecnomotriz_control_tareas/provider/welcome_message_provider.dart';
import 'package:tecnomotriz_control_tareas/screens/qr_scanner.dart';
...
class _LoginPageState extends State<LoginPage> {
  ...
  final welcomeMessageProvider = WelcomeMessageProvider();
              ...
              ? Padding(
                  ...
                  child: ElevatedButton(
                    onPressed: (!snapshot.hasData)
                        ? () async => await _login(bloc, context)
                        : null,
  ...
  Future<void> _login(LoginBloc bloc, BuildContext context) async {
    bool readCode = await _scanQRCode();
    ...
    if (readCode) {
      ...
      if (!info['error']) {
        Navigator.of(context)
            .pushReplacementNamed('home', arguments: info['employee']);
      } else {
  ...
  Future<bool> _scanQRCode() async {
    ...
    var barcodeScanRes = await Navigator.of(context).push(
      MaterialPageRoute(
