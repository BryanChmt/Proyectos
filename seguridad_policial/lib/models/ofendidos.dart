...
class Ofendidos extends StatefulWidget {
  //controllers
 final TextEditingController nombre = TextEditingController();
  ...
  var selecteditems = [];
  @override
  _OfendidosState createState() => _OfendidosState();
}

class _OfendidosState extends State<Ofendidos> {
  @override
      ...
      Container(
        ...
        Row(
          children: [
            Flexible(
              flex: 2,
              child: textforms('NOMBRE',widget.nombre),
            ),
            Flexible(
              flex: 2,
              child: textforms('CEDULA O PASAPORTE',widget.cedula),
            ),
        ...
        Row(
          children: [
            ...
            Flexible(
              flex: 2,
              child: textforms(
                'NACIONALIDAD',widget.nacionalidad
              ),
            ),
            Flexible(
              flex: 2,
              child: textforms(
                'FECHA DE NACIMIENTO',widget.fechanacimiento
              ),
            ),
          ],
        ),
        Padding(
          ...
          child: textboxgrandes(context, 'DIRECCIÓN EXACTA', 3,widget.direccion),
        ),
        Padding(
